...
all: loader.bin bootloader_loader.bin romfs.bin romfs_no_bootloader.bin

romfs.bin: romfs.o
	$(CL) $(LFLAGS) -C $(ROMFS_CFG) -o romfs.bin romfs.o

romfs_no_bootloader.bin: romfs_no_bootloader.o
	$(CL) $(LFLAGS) -C $(ROMFS_CFG) -o romfs_no_bootloader.bin romfs_no_bootloader.o
...
romfs.o: bootloader_loader.bin
	$(CA) $(AFLAGS) -D INC_BOOTLOADER=1 -o romfs.o romfs.a65

romfs_no_bootloader.o:
	$(CA) $(AFLAGS) -o romfs_no_bootloader.o romfs.a65
